...
rel = 3 # l-integer if homogeneous relations Rad^l, or a list of minimal zero-relations given through the vertices they start and end in 
...
yLevels = [5,-1,4] #Set the y-level which the tauOrbits of each projective is drawn
